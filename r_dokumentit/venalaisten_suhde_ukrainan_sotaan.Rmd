...
![Kuva 16.](images/levada_vtsiom_rankingit.png)
...
Vaikka ottaisimme huomioon edellä mainitun pohdinnan, emme tietenkään voi varmuudella sanoa, vastaavatko venäläiset rehellisesti kyselyihin vai eivät. On kuitenkin syytä muistaa, että 100% luotettavaa tutkimusaineistoa ei ole olemassakaan. Humanistisessa ja yhteiskuntatieteellisessä tutkimuksessa ei voi myöskään tehdä samanlaisia empiiriisiä toistokokeita, jotka ovat joissain matemaattis-luonnontieteellisissä tutkimuksissa mahdollisia. Samalla on kuitenkin syytä huomauttaa, että monet kyselytutkimuksissa olevat epävarmuustekijät (aineiston vääristely ja luotettavuus, epärehelliset vastaukset ja/tai itsesensuuri, tietynlaisten ihmisten valikoituminen) ovat läsnä myös muussa sosiaalitieteellisessä tutkimuksessa, kuten pienemmissä ryhmissä tehtävissä laadullisissa syvähaastatteluissa. Jos kyselytutkimusten kärkkäimpien kriitikoiden kriteerejä sovellettaisiin muuhun sosiaalitieteelliseen tai Venäjä-tutkimukseen, ei tällaista tutkimusta olisi ylipäänsä mahdollista tehdä.

Tämä ei tarkoita sitä, että venäläisiin kyselytutkimuksiin voi suhtautua kritiikittä ja olettaa tulosten kuvastavan täydellisesti venäläisten (enemmistön) mielipiteitä.
...
Jälleen kerran on vaikea antaa yksiselitteistä vastausta ihmisten motiiveilla osallistua tai olla osallistumatta kyselytutkimuksiin. Etenkin venäläisiä kyselytutkimuksia kritisoivan venäläissosiologi Grigori Judinin mukaan vastausprosentit ovat Venäjällä olleet pitkään hyvin matalia [@mostovshchikov2022; @napreenko2017]. Lisäksi tilanteen on esitetty pahentuneen entisestään Venäjän hyökättyä Ukrainaan, ja on esitetty, että tällä hetkellä kyselyiden vastausprosentti on vain 5% luokkaa [@kac2022; @morris2022a].

Tässä blogitekstissä käsittelevien kyselytutkimusten aineistoista on kuitenkin hankalaa päätellä, keitä kyselyyn osallistujat ovat. VTsIOM ei raportoi vastausprosenttia, vaan ainoastaan kyselyyn vastanneet tahot. Toisin sanoen, vaikka otanta on yhteensä 3200, ei kerrota, kuinka monelle ihmiselle oli soitettava jotta saatiin 3200 vastaajaa kyselyyn. Riippummattoman tutkijaryhmän kyselyn osalta tämä luku oli kuitenkin raportoitu: tämän kyselyn tekijöiden oli soitettava 27751 ihmisille, jotta 1640 vastaajaa saatiin täyteen. Näin ollen tämän kyselyn vastausprosentti oli noin 6% luokkaa, mikä kieltämättä kielii laajasta haluttomuudesta osallistua sotaan liittyviin kyselyihin.

## Lopuksi

Vaikka ottaisimme huomioon edellä mainitun pohdinnan, emme tietenkään voi varmuudella sanoa, kuinka luotettavia tässä esitellyt kyselyt ovat. On kuitenkin syytä muistaa, että 100% luotettavaa tutkimusaineistoa ei ole olemassakaan. Humanistisessa ja yhteiskuntatieteellisessä tutkimuksessa ei voi myöskään tehdä samanlaisia empiiriisiä toistokokeita, jotka ovat joissain matemaattis-luonnontieteellisissä tutkimuksissa mahdollisia. Samalla on kuitenkin syytä huomauttaa, että monet kyselytutkimuksissa olevat epävarmuustekijät (aineiston vääristely ja luotettavuus, epärehelliset vastaukset ja/tai itsesensuuri, tietynlaisten ihmisten valikoituminen) ovat läsnä myös muussa sosiaalitieteellisessä tutkimuksessa, kuten esimerkiksi pienemmissä ryhmissä tehtävissä laadullisissa syvähaastatteluissa. Jos kyselytutkimusten kärkkäimpien kriitikoiden kriteerejä sovellettaisiin muuhun sosiaalitieteelliseen tai Venäjä-tutkimukseen, ei tällaista tutkimusta olisi ylipäänsä mahdollista tehdä.

Tämä ei tarkoita sitä, että venäläisiin kyselytutkimuksiin voi suhtautua kritiikittä ja olettaa tulosten kuvastavan täydellisesti venäläisten (enemmistön) mielipiteitä. Kuten sanottua, täydellistä tutkimusaineistoa ei ole olemassa, ja jokaisessa aineistossa on omat vahvuutensa ja heikkoutensa. Yhtäältä emme kuitenkaan voi myöskään suoralta kädeltä sanoa, että kyselytutkimukset venäläisten suhtautumisesta meneillä olevasta Ukrainan sodasta olisivat täysin perättömiä nollatutkimuksia. Sen vuoksi meidän olisi mielestäni hyväksyttävä myös se mahdollisuus -- niin surullista kuin se onkin -- että valtaosa Venäjän kansasta jos nyt ei suoraan tue, niin ainakin antaa hiljaisen hyväksyntänsä Venäjän hyökkäykselle Ukrainaan. Samalla olisi hyvä pohtia, millaisia vaikutuksia tällä on Ukrainan, Suomen, Euroopan ja Venäjän tulevaisuudelle.

## Huonot asteikot

Kuten jo blogitekstini aluksi mainitsin, erilaisten poliittisten toimien hyväksyntää voidaan tiedustella joko kaksiluokkaisella "kyllä-ei"-asteikolla tai
