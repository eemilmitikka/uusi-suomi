...
png(filename = "vtsiom_ika_vs_kannatus.png", width = 1068, height = 841, res = 85)
sota_tuki_vs_ika %>% 
  filter(ika <= 75) %>% 
...
png("vtsiom_ika_sukupuoli.png", width = 1068, height = 841, res = 85)
...
png("vtsiom_netti_vs_kannatus.png", width = 1068, height = 841, res = 85)
...
png("vtsiom_tv_vs_kannatus.png", width = 1068, height = 841, res = 85)
...
#   mutate(prosentti = n / sum(n))
# 
# # Riippumaton data: kaupunki ja koulutus -kuva
# png("jee.png", width = 1068, height = 841, res = 85)
...
png("vtsiom_asuinalue_koulutus_vs_kannatus.png", width = 1068, height = 841, res = 85)
...
png("riipp_kannatus_likert.png", width = 1068, height = 841, res = 85)
...
png("riipp_sota_kannatus_3luokkaa.png", width = 1068, height = 841, res = 85)
...
png("riipp_ika_vs_kannatus.png", width = 1068, height = 841, res = 85)
...
png("riipp_ika_sukupuoli_vs_kannatus.png", width = 1068, height = 841, res = 85)
...
kuva_speksit <- paste0("width = 1068, heigth = 841, res = 85")

# Riippumaton data visualisointi: netti ja ikä vs. sodan kannatus 
png("riipp_netti_ikaluokat_vs_kannatus.png", width = 1068, height = 841, res = 85)
ggplot(riipp_netti_ja_tuki, aes(fill = sota_tuki_2luokka, y = prosentti, x = ikaluokat)) +
  geom_bar(position = "fill", stat = "identity") +
...
png("riipp_tv_vs_tuki.png", width = 1068, height = 841, res = 85)
...
png("riipp_kannattus_kartta.png", width = 987, height = 816, res = 85)
...
png("riipp_kannatus_kartta.png", width = 987, height = 816, res = 85)
kartta_graafi_painotettu %>% 
...
# # Laske painotetut keskiarvot sodan tuelle alueittain
# vtsiom_kartta_data_painotettu <- svyby(~sota_hyvaksynta, # filtteröity tukidata
#                                 ~federaatio_piiri, # asuinalue
#                                 vtsiom_kartta_data_design, # painot
#                                 svymean, # menetelmä (keskiarvo)
#                                 na.rm = TRUE) # poista puuttuvat arvot
...
png("vtsiom_kannatus_kartta.png", width = 987, height = 816, res = 85)
